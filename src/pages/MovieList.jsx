    ...
    return(
        <div>
            ...
            <div className="mt-16 p-4">
                ...
                {data?.pages[0].results.length > 0 && <h1 className="text-2xl mb-4">Showing results for  <span className="font-semibold">"{query}"</span> ({data?.pages[0].total_results} matches found)</h1>}
